...
class SecondViewController: UIViewController, THContactPickerDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.contactPickerView.setPlaceholderLabelText("Hello World")
        ...
        let tableFrame = CGRectMake(0, self.contactPickerView.frame.size.height, self.view.frame.size.width, self.view.frame.size.height - self.contactPickerView.frame.size.height)
    ...
    override func viewWillAppear(animated: Bool) {
        //self.contactPickerView.frame = CGRectMake(0, 0, self.view.frame.size.width, 100)
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell  {
        println(self.contactPickerView.frame)
